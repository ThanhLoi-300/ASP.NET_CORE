...
namespace ASP.NET_CORE.SERVICE.Interface
{
    public interface IProduct
    {
        ...
        int count_Product_Items(String search, List<int> category_Id);
        List<Product> data_In_Page(int page, int page_Size, String search, int category_Id);
        List<Product> data_In_Page(int page, int page_Size, string search, List<int>? category_Id, String Type);
